...
export const glyph = {
  id: 'CHUEN',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Чуен',       // Українська назва для інтерфейсу
  nameEn: 'Chuwen',     // Англійська транслітерація
  order: 11,            // Порядковий номер у Цолькін (1–20)
