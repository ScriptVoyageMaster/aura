...
export const glyph = {
  id: 'CHICCHAN',       // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Чікчан',     // Українська назва для інтерфейсу
  nameEn: 'Chicchan',   // Англійська транслітерація
  order: 5,             // Порядковий номер у Цолькін (1–20)
