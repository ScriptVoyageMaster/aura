...
export const glyph = {
  id: 'CIMI',           // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Цімі',       // Українська назва для інтерфейсу з літерою «Ц»
  nameEn: 'Cimi',       // Англійська транслітерація у канонічному записі
  order: 6,             // Порядковий номер у Цолькін (1–20)
