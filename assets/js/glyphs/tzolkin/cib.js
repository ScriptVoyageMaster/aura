...
export const glyph = {
  id: 'CIB',            // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Кіб',        // Українська назва для інтерфейсу
  nameEn: 'Kib’',       // Англійська транслітерація
  order: 16,            // Порядковий номер у Цолькін (1–20)
