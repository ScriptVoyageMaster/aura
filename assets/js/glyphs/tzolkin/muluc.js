...
export const glyph = {
  id: 'MULUC',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Мулук',      // Українська назва для інтерфейсу
  nameEn: 'Muluc',      // Англійська транслітерація
  order: 9,             // Порядковий номер у Цолькін (1–20)
