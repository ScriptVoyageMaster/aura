...
export const glyph = {
  id: 'IK',             // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Ік’',        // Українська назва для інтерфейсу
  nameEn: 'Ik’',        // Англійська транслітерація
  order: 2,             // Порядковий номер у Цолькін (1–20)
