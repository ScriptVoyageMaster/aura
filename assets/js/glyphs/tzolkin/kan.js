...
export const glyph = {
  id: 'KAN',            // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Кан',        // Українська назва для інтерфейсу
  nameEn: 'K’an',       // Англійська транслітерація
  order: 4,             // Порядковий номер у Цолькін (1–20)
