...
export const glyph = {
  id: 'LAMAT',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Ламат',      // Українська назва для інтерфейсу
  nameEn: 'Lamat',      // Англійська транслітерація
  order: 8,             // Порядковий номер у Цолькін (1–20)
