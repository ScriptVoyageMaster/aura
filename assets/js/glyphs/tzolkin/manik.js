...
export const glyph = {
  id: 'MANIK',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Манік',      // Українська назва для інтерфейсу
  nameEn: 'Manik’',     // Англійська транслітерація
  order: 7,             // Порядковий номер у Цолькін (1–20)
