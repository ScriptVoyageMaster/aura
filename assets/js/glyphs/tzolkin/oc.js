...
export const glyph = {
  id: 'OC',             // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Ок',         // Українська назва для інтерфейсу
  nameEn: 'Ok',         // Англійська транслітерація
  order: 10,            // Порядковий номер у Цолькін (1–20)
