...
export const glyph = {
  id: 'IMIX',           // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Іміш',       // Українська назва для інтерфейсу
  nameEn: 'Imix',       // Англійська транслітерація
  order: 1,             // Порядковий номер у Цолькін (1–20)
