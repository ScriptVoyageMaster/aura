...
export const glyph = {
  id: 'CABAN',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Кабан',      // Українська назва для інтерфейсу
  nameEn: 'Kab’an',     // Англійська транслітерація
  order: 17,            // Порядковий номер у Цолькін (1–20)
