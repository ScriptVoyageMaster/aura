...
export const glyph = {
  id: 'AHAU',           // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Ахау',       // Українська назва для інтерфейсу
  nameEn: 'Ahau',       // Англійська транслітерація
  order: 20,            // Порядковий номер у Цолькін (1–20)
