...
export const glyph = {
  id: 'CAUAC',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Кавак',      // Українська назва для інтерфейсу
  nameEn: 'Cauac',      // Англійська транслітерація
  order: 19,            // Порядковий номер у Цолькін (1–20)
