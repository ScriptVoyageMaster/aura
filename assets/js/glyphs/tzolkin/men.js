...
export const glyph = {
  id: 'MEN',            // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Мен',        // Українська назва для інтерфейсу
  nameEn: 'Men',        // Англійська транслітерація
  order: 15,            // Порядковий номер у Цолькін (1–20)
