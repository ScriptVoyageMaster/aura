...
export const glyph = {
  id: 'AKBAL',          // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Акбал',      // Українська назва для інтерфейсу
  nameEn: 'Ak’bal',     // Англійська транслітерація
  order: 3,             // Порядковий номер у Цолькін (1–20)
