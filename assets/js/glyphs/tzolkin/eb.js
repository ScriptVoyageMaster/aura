...
export const glyph = {
  id: 'EB',             // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Еб',         // Українська назва для інтерфейсу
  nameEn: 'Eb’',        // Англійська транслітерація
  order: 12,            // Порядковий номер у Цолькін (1–20)
