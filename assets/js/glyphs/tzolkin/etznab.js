...
export const glyph = {
  id: 'ETZNAB',         // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Ецнаб',      // Українська назва для інтерфейсу
  nameEn: 'Etz’nab',    // Англійська транслітерація
  order: 18,            // Порядковий номер у Цолькін (1–20)
