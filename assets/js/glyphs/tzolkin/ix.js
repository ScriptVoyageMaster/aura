...
export const glyph = {
  id: 'IX',             // Сталий ID (верхній регістр), зручно для мапінгу
  nameUa: 'Іш',         // Українська назва для інтерфейсу
  nameEn: 'Ix',         // Англійська транслітерація
  order: 14,            // Порядковий номер у Цолькін (1–20)
