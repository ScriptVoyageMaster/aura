...
function parseCliArguments() {
  ...
  for (const arg of args) {
    ...
    } else if (arg === "--force-sitemap" || arg === "--forceSitemap") {
      // Підтримуємо обидва формати написання, щоб не зламати вже наявні інструкції.
...
function printHelpAndExit() {
  ...
  console.log("--force-sitemap / --forceSitemap — примусово перебудовує sitemap-и навіть без змін сторінок.");
  process.exit(0);
}
